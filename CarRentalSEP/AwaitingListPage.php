...
$query="SELECT * FROM carbooking JOIN customer ON customer.CustomerID=carbooking.CustomerID JOIN user ON user.UserID=customer.UserID  WHERE Car_status = 'AWAIT'";
...
<?php
	while($rows=mysqli_fetch_array($result))
	{
		...
		<td><?php echo "<a href='updatereturn.php?id=".$rows['BookingID']."' onclick=\"return confirm('Are you sure to return this rental?')\">Return</a>";?></td>
		</tr>
		<?php
	}
	?>
